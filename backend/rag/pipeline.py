...
class RAGPipeline:
    ...
    def _precompute_bm25_stats(self) -> None:
        ...
        logger.info(f"BM25 index built for {len(corpus)} documents")
    ...
    async def _rerank_results(self, query: str, results: List[Dict], intent: Optional[IntentType] = None) -> List[Dict]:
